...
--Question 1
select*from Works_no

--Question 2

select emp_no from Works_no where Job='Clerk'

--Question 3

select emp_no from  Works_no where project_no='p2'
